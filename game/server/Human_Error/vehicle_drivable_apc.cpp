...
// Purpose: 
//-----------------------------------------------------------------------------
void CPropDrivableAPC::TraceAttack( const CTakeDamageInfo &info, const Vector &vecDir, trace_t *ptr, CDmgAccumulator *pAccumulator )
{
    ...
    if ( ptr->hitbox != VEHICLE_HITBOX_DRIVER )
    {
        ...
        {
            adjustedInfo.ScaleDamage( 0.0001f );
        }
    }

    BaseClass::TraceAttack( adjustedInfo, vecDir, ptr, pAccumulator );
}
