...
//#define BEE_FLY_TO_OWNER 

#define BEE_THINK_INTERVAL 0.08f

class CBee :  public  CAI_BaseNPC //CBaseCombatCharacter//, virtual public CBaseAnimating
{
	DECLARE_CLASS( CBee,  CAI_BaseNPC ); //CBaseCombatCharacter ); //CAI_BaseNPC
