...
public:
	...
	{
		#define SMG2_BIGGEST_SPREAD 0.13053 //0.08716
		#define SMG2_SMALLEST_SPREAD 0.00873

		//static const Vector cone = VECTOR_CONE_5DEGREES;
		float flCone = clamp( (float)m_nShotsFired / 30.0f, 0.0f, 1.0f);
		flCone = (SMG2_BIGGEST_SPREAD * (1.0f - flCone)) + (SMG2_SMALLEST_SPREAD * flCone);

		return Vector(flCone, flCone, flCone + 0.008);
	}

	/*virtual const Vector& GetBulletSpread( void )
	{

#define SMG2_BIGGEST_SPREAD 0.08716


		DevMsg("m_nShotsFired %d\n", m_nShotsFired );
